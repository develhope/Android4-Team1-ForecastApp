...
class TomorrowFragment : Fragment() {
    ...
    private val rowTomorrowScreen = TomorrowRow(OffsetDateTime.now(),14,80,15,1/10,20,"NNE 1km/H",3,0)
    private val rowTomorrowScreen2 = TomorrowRow(OffsetDateTime.now().plusHours(1),15,80,13,2/10,50,"NNE 1km/h",5,10)
    private val rowTomorrowScreen3 = TomorrowRow(OffsetDateTime.now().plusHours(2),16,80,12,1/10,80,"NNE 1km/h",3,0)
    private val rowTomorrowScreen4 = TomorrowRow(OffsetDateTime.now().plusHours(3),16,80,12,1/10,80,"NNE 1km/h",3,0)
    private val rowTomorrowScreen5 = TomorrowRow(OffsetDateTime.now().plusHours(4),16,80,12,1/10,80,"NNE 1km/h",3,0)
    private val rowTomorrowScreen6 = TomorrowRow(OffsetDateTime.now().plusHours(5),17,80,12,1/10,80,"NNE 1km/h",3,0)
    private val rowTomorrowScreen7 = TomorrowRow(OffsetDateTime.now().plusHours(6),17,80,12,1/10,80,"NNE 1km/h",3,0)
